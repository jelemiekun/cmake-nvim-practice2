...
function(link_all)
  ...
  target_link_libraries(Game PUBLIC spdlog::spdlog SDL2::SDL2 glad Practice ImGUIWindow)
  target_link_libraries(VertexBuffer PUBLIC glad)
  target_link_libraries(Shader PUBLIC glad)
  target_link_libraries(Practice PUBLIC SDL2::SDL2 glad Model Camera)
  ...
  target_link_libraries(ImGUIWindow PUBLIC SDL2::SDL2 spdlog::spdlog glad imgui)
